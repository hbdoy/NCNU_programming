...
public class HW8
{
    public static void main(String[] args)
    {
        ...
        LSNode Head01; Head01 = null;
        LSNode Tail01; Tail01 = null;
        int Length01 = 0;
        ...
        LSNode Head02; Head02 = null;
        LSNode Tail02; Tail02 = null;
        int Length02 = 0;

        for (int i = 1; i <= 20; i++)
        {
            LSNode node = new LSNode(CNamePool[ran.nextInt(20)],(ran.nextInt(71)+10));
...
class LSNode
{
    ...
    public void LS_CountLength(LSNode Head, /*ref*/ int Length)
    {
     ...
     public boolean LS_InsertAt(LSNode node, /*ref*/ LSNode Head, /*ref*/ LSNode Tail, /*ref*/ int Length, int location)
     {
        ...
        {
            i = 1;
            LSNode ptr1; ptr1 = null;
            LSNode ptr2; ptr2 = null;
            ptr1 = Head;
            while (i != location)
            {
                i++;
     ...
     public boolean LS_Remove(/*ref*/ LSNode Head, /*ref*/ LSNode Tail, /*ref*/ int Lenghth)
     {
         ...
         {
             LSNode ptr01, ptr02; ptr01=null; ptr02=null;
             ptr02=Head;
             ptr01 = Head.Next;
             while (ptr01 != Tail)
             {
     ...
     {
         LSNode forward; forward = null;
         LSNode current; current = null;
         LSNode prev; prev = null;
         if ((Head == null) || (Tail == null))
             return;
         else
         {
